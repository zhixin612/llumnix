...
python ../benchmark/bench_plus.py \
    ...
    --log_dir               "./logs/test-minimal-overhead/fix-256-256-Q24-1P1D-NCCL"
sleep 10
...
python ../benchmark/bench_plus.py \
    ...
    --log_latencies \
    --fail_on_response_failure \
    --log_dir               "./logs/test-minimal-overhead/fix-256-256-Q32-1P1D-NCCL"
sleep 10
...
python ../benchmark/bench_plus.py \
    ...
    --log_latencies \
    --fail_on_response_failure \
    --log_dir               "./logs/test-minimal-overhead/fix-256-256-Q36-1P1D-NCCL"
sleep 10
...
python ../benchmark/bench_plus.py \
    ...
    --log_latencies \
    --fail_on_response_failure \
    --log_dir               "./logs/test-minimal-overhead/fix-1k-256-Q16-1P1D-NCCL"
sleep 10
...
python ../benchmark/bench_plus.py \
    ...
    --log_latencies \
    --fail_on_response_failure \
    --log_dir               "./logs/test-minimal-overhead/fix-1k-256-Q24-1P1D-NCCL"
sleep 10
...
python ../benchmark/bench_plus.py \
    ...
    --log_latencies \
    --fail_on_response_failure \
    --log_dir               "./logs/test-minimal-overhead/fix-1k-256-Q32-1P1D-NCCL"
sleep 10
